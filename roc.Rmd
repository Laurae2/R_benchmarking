...
set.seed(11111)
data <- runif(500000, 0, 1)
labels <- round(runif(500000, 0, 1), digits = 0)
...
# ===== BLOCK 2 =====
cppFunction("double faster2(NumericVector preds, NumericVector labels) {
  ...
  NumericVector x2(n2);
  ranked[seq(n1, LabelSize - 1)] = negatives;
...
bench_runs <- c(50000, 10000, 5000, 1000, 100, 10)
